...
export type Author = { id: string; name: string; slug: string; image?: string; bioHtml?: string }
export type Post = {
  id: string
  slug: string
  title: string
...
export type Settings = { siteTitle: string; description?: string; accent: string }
...
export const MOCK_POSTS: Post[] = [
  {
    ...
    excerpt: "Claves para navegar un entorno de tasas altas: dónde están las primas de riesgo y cómo posicionarse.",
    date: "2025-08-03",
    coverImage: "/placeholder.svg?height=720&width=1280",
    author: MOCK_AUTHORS[0],
    categories: ["inversion"],
    contentHtml:
      "<p>Contexto macro: balance entre inflación y crecimiento. Liquidez y spreads como variables críticas.</p>",
    featured: true,
  },
  {
    id: "p1",
    ...
    excerpt: "Estrategias prácticas para balancear riesgo y retorno usando ETFs, bonos y posiciones en efectivo.",
    date: "2025-08-02",
  ...
  },
  {
    ...
    excerpt: "Batallas de QBs, esquemas defensivos y novatos clave que podrían cambiar la temporada.",
    date: "2025-08-02",
    coverImage: "/placeholder.svg?height=360&width=640",
  ...
  },
  {
    ...
    excerpt: "Analizamos estilos, cardio y grappling que podrían definir los matchups principales.",
    date: "2025-08-01",
    coverImage: "/placeholder.svg?height=360&width=640",
  ...
  },
  {
    ...
    excerpt: "Cómo interpretar el sentimiento de mercado sin caer en señales falsas.",
    date: "2025-07-28",
    coverImage: "/placeholder.svg?height=360&width=640",
    author: MOCK_AUTHORS[0],
    categories: ["inversion"],
    contentHtml: "<p>El sentimiento es un factor, no el sistema. Úsalo como confirmación, no como disparador.</p>",
  },
  {
    id: "p5",
    slug: "defensa-nickel-nfl",
    title: "La defensa Nickel y su evolución en la NFL moderna",
    excerpt: "Por qué los coordinadores defensivos priorizan paquetes con 5 DBs.",
    date: "2025-07-25",
    coverImage: "/placeholder.svg?height=360&width=640",
    author: MOCK_AUTHORS[2],
    categories: ["nfl"],
    contentHtml: "<p>La proliferación de sets 11 personnel obliga a defensas más ligeras y versátiles.</p>",
  },
]
...
export const MOCK_RECAPS: Recap[] = [
  {
    ...
    date: "2025-08-03",
    marketsHtml: "<p>Semana de baja volatilidad. T-bills al 4.9% siguen atractivos.</p>",
    nflHtml: "<p>QB1 definido en varios equipos; atención a OL con lesiones.</p>",
    ufcHtml: "<p>Cartelera con finalistas de TUF; co-main con estilos contrastantes.</p>",
    extrasHtml: "<p>Lectura: decisiones bajo incertidumbre y sesgos comunes.</p>",
  },
  {
    id: "r2",
